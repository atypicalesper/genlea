/**
 * Human-intervention alert via email.
 *
 * Sends a plain-text email when an agent fails and needs human review.
 * Configure via env vars (see .env.example). If ALERT_EMAIL_TO is not set,
 * alerts are logged at warn level but no email is sent.
 */
...
/**
 * Convenience: send a structured agent-failure alert.
 */
