...
export async function settingsRoutes(app: FastifyInstance) {
  ...
  app.patch<{ Body: Record<string, unknown> }>('/settings', async (req, reply) => {
    const allowed = ['originRatioThreshold', 'originRatioMinSample', 'leadScoreHotVerifiedThreshold', 'leadScoreHotThreshold', 'leadScoreWarmThreshold', 'leadScoreColdThreshold', 'workerConcurrencyDiscovery', 'workerConcurrencyEnrichment', 'workerConcurrencyScoring'];
